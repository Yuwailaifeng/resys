...
def run(idx, device_uuid):
    ...
    with grpc.insecure_channel("10.129.23.11:4245") as channel:
        ...
        reco_request = RecoRequest(device_uuid=device_uuid, channel_id="1623515436593418240", request_num=50)
    ...
    print(idx, device_uuid, "Total time %s" % (time.time() - start), "\n")
