...
i2i_recall_file_list = [
    "item2vec_album/model_data/" + str(file_hour) + ".content_similarity_channel.txt",
    "item2vec_single/model_data/" + str(file_hour) + ".content_similarity_channel.txt",
]

u2i_recall_file_list = [
    "item2vec_album/model_data/" + str(file_hour) + ".user_content_reco_channel.txt",
    "item2vec_single/model_data/" + str(file_hour) + ".user_content_reco_channel.txt",
]
